    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container px-5">
                <a class="navbar-brand" href="index.html"><span class="fw-bolder text-primary">UMBY</span></a>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <div class="fs-3 fw-light text-muted">Hallo, Welcome</div>
                            <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Rizky Nurdiansyah</span></h1>
                            <div
